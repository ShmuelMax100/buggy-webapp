 ...
 *
 * FIX: GET /api/products now reads from `db.products` (was `db.catalog.items`
 * which threw TypeError because `db.catalog` was null).
 */
...
app.listen(PORT, () => {
  ...
  console.log('  GET /api/products → product listing (OK)');
});
