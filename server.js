 ...
 *
 * FIX: GET /api/products now reads from `db.products` instead of the
 * previously incorrect `db.catalog.items` (db.catalog was null), which
 * caused a TypeError → 500 Internal Server Error.
 */
...
app.listen(PORT, () => {
  ...
  console.log('  GET /api/products → products list (fixed)');
});
