...
// ── FIXED: /api/products → Now reads from db.products ─────────────────────────
app.get('/api/products', (_req, res) => {
  try {
    const items = db.products;   // ← Fixed: Accessing valid products data
...
app.listen(PORT, () => {
  ...
  console.log('  GET /api/products → Fixed: Returns products data');
});